...
public:
  enum open_mode_t { read_only=O_RDONLY, read_write=O_RDWR, write_only=O_WRONLY,
                     create=O_WRONLY|O_CREAT, append=O_WRONLY|O_APPEND };
...
// The following is known to work with g++ 3.4.3, and hopefully
// newer versions.  If you have an earlier version that works
// with this please let me know.
#if __GLIBCXX__ >= 20041105
