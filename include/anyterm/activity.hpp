...
namespace anyterm {
  ...
  struct activity_base {
    ...
    public:
      ...
      activity_base(on_output_slot_t on_output_in, on_error_slot_t on_error_in, ::boost::shared_ptr<
          ::asiop::stream_descriptor > stream_inout);
